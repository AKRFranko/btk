...
<div id="page" class="site">
  <header id="masthead">
      ...
      <nav id="site-nav">
        ...
        <a class="logout" href="<?php echo wp_logout_url( home_url('/') ); ?>">Welcome <b><?php echo $current_user->user_nicename; ?></b>, <?php _e('sign out', 'btk'); ?></a>
        <?php else: ?>
        <a class="login" href="<?php echo esc_url(home_url('/')); ?>sign-in"><?php _e('Sign in', 'btk'); ?></a>
        <?php endif; ?>
      ...
      <div class="register-form">
        ...
        <form method="post" action="<?php echo esc_url(home_url('/')); ?>my-account">
          ...
          <p class="submit">
            ...
            <span class="valign"><?php _e('sign up to edb', 'btk'); ?></span>
