  ...
  <fieldset id="place-order-panel" class="checkout-panel">
    ...
    <div class="box-half">
       ...
       <div class="cart-checklist">
         <h1>Checklist</h1>
         <div class="checklist-checkbox"><input type="checkbox" name="final_checklist_fits"> I made sure the item fits.</div>
         <div class="checklist-checkbox"><input type="checkbox" name="final_checklist_noinclude"> The delivery does not include...</div>
         <div class="checklist-checkbox"><input type="checkbox" name="final_checklist_variation"> I am aware that there can be slight variation in the colors of the swatches and the dinal product due to dye lot difference.</div>
       </div>
    </div>
