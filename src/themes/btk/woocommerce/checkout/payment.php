...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<?php if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) : ?>
		<p class="form-row terms">
			...
			<label for="terms" class="checkbox small"><?php printf( __( 'I agree with the <a href="%s" target="_blank">terms &amp; conditions</a>', 'woocommerce' ), esc_url( wc_get_page_permalink( 'terms' ) ) ); ?></label>
		</p>
	<?php endif; ?>
