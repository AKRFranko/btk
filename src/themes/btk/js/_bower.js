...
/* edb icon loader setup */
!(function( load ){ 
  var base  = "/wp-content/themes/btk/icons/";
  var files = ["icons.data.svg.css", "icons.data.png.css", "icons.fallback.css"];
  return load( files.map( function( f ){
    return base + f;
  })); 
})( grunticon );
