...
<div class="cart_item">
  <div class="cart-item-image">
    ...
    <?php
        ...
        echo $package_product->get_image();
    ?>
  </div>
    ...
    <div class="cart-item-remove">
      <?php
        echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
          '<a href="%s" class="remove" title="%s" data-product_id="%s" data-product_sku="%s" data-product_qty="%n">&times;</a>',
          esc_url( WC()->cart->get_remove_url( $package['cart_item_key']) ),
          __( 'Remove this item', 'woocommerce' ),
          esc_attr( $package_product->ID ),
          esc_attr( $package_product->get_sku() ),
          esc_attr( $product_qty )
        ), $package['cart_item_key'] );
      ?>
    </div>
  </div>
